...
(async () => {
    ...
    await cluster.task(async ({ page, data }) => {
        ...
        await page.goto("https://www.google.com/search?q=" + searchTerm + "&start=" + offset, {
    ...
    cluster.queue({ data: { searchTerm: "puppeteer-cluster", offset: 0 } });
    cluster.queue({ data: { searchTerm: "puppeteer-cluster", offset: 10 } });
